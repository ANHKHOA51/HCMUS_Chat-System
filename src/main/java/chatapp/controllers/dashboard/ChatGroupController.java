...
public class ChatGroupController extends DashboardController {
    ...
    void getMember(ActionEvent event) {
        ...
        memberNameCol.setCellValueFactory(new PropertyValueFactory<User, String>("userAccount"));
    ...
    void getAdmin(ActionEvent event) {
        ...
        adminNameCol.setCellValueFactory(new PropertyValueFactory<User, String>("userAccount"));
